        ...
        <div className="container detail-product-wrapper pb-5">
            ...
            <div className="product-detail-main-section">
              ...
              <div className="product-detail-info-section">
                ...
                <button className={this.state.size ? "btn btn-md btn-primary button-detail-product" : "btn btn-md btn-primary button-detail-product disabled"} onClick={() => this.addingToCart(myProduct)}>Add to cart</button>
