  ...
  return (
    ...
    <div className="container landing-navbar2">
      ...
      <div className="navbar-items2">
          ...
          <div className="nav-bar-li2 newli2"><Link className="Link" to={`/shops/${shop.name}/products`}>Products</Link></div>
          <div className="nav-bar-li2 newli3"><Link className="Link" to={`/shops/${shop.name}/orders`}>Orders</Link></div>
          <div className="nav-bar-li2 newli4"><Link className="Link" to={`/shops/${shop.name}/`}>Log out</Link></div>
      </div>
    </div>
  )
}
